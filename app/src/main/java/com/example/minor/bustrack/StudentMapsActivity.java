package com.example.minor.bustrack;
...
public class StudentMapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private String busDriverKey ="H4RRBGutTpdSwkHxYOhHmAKYSG22";
            ...
            metadialogBuilder.setTitle(getString(R.string.selectBusTitle))
                    .setItems(R.array.bus_numbers, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            DatabaseReference ref = FirebaseDatabase.getInstance("https://mybus-6e2fc-default-rtdb.firebaseio.com/").getReference().child("Buses").child(String.valueOf(bus_num)).child(uId);
...
//        });
        ...
        locateBus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference busLocation = FirebaseDatabase.getInstance("https://mybus-6e2fc-default-rtdb.firebaseio.com/").getReference().child("driver_available").child(busDriverKey).child("l");
                busLocation.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()){
                            ...
                            mBusMarker = mMap.addMarker(new MarkerOptions().position(busLocation).title("Your is bus here"));
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.eta:
                        String uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                        DatabaseReference reference = FirebaseDatabase.getInstance("https://mybus-6e2fc-default-rtdb.firebaseio.com/").getReference().child("request_eta");
                        GeoFire geoFire = new GeoFire(reference);
                        geoFire.setLocation(uid, new GeoLocation(mLastKnownLocation.getLatitude(), mLastKnownLocation.getLongitude()));
                        // getDriverLocation();
                    ...
                    case R.id.request_wait:
                        ...
                        DatabaseReference ref = FirebaseDatabase.getInstance("https://mybus-6e2fc-default-rtdb.firebaseio.com/").getReference().child("request_wait");
                        ...
                        DatabaseReference busRef = FirebaseDatabase.getInstance("https://mybus-6e2fc-default-rtdb.firebaseio.com/").getReference().child("Buses").child(String.valueOf(bus_num));
                        busRef.addChildEventListener(new ChildEventListener() {
                            ...
                            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                                ...
                                if (isDriver.equals("driver")){
                                    ...
                                    DatabaseReference driverRef = FirebaseDatabase.getInstance("https://mybus-6e2fc-default-rtdb.firebaseio.com/").getReference().child("Users")
                                            .child("Driver")
                                            .child(busDriverKey)
