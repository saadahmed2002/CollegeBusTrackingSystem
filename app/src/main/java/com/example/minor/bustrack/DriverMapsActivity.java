...
public class DriverMapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference requestRef = FirebaseDatabase.getInstance("https://mybus-6e2fc-default-rtdb.firebaseio.com/").getReference().child("Users").child("Driver").child(uid);
    ...
    public void onLocationChanged(Location location) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://mybus-6e2fc-default-rtdb.firebaseio.com/").getReference().child("driver_available");
        GeoFire geoFire = new GeoFire(reference);
